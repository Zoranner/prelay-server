...
use crate::{
    ...
    bridge::{
        anthropic::encode::encode_anthropic_response, internal::InternalRequest,
        stream::chat_sse_response_to_anthropic_messages_sse_with_stats,
    },
    error::AppError,
...
pub(super) async fn create_chat_anthropic_message(
    state: &AppState,
