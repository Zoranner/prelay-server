...
fn source_modules_use_domain_directories() {
    ...
    let required_files = [
        ...
        "routes/v1/chat/tests/activities.rs",
        ...
        "routes/v1/messages/tests/activities.rs",
        ...
        "routes/v1/responses/tests/activities.rs",
